...
const Shoulders = () => {
  ...
  return (
    <animated.div style={fade} className={p90xStyles.container}>
      ...
      <div className={cardStyles.mobility}>
        ...
        <div className={cardStyles.box}>
          <div className={cardStyles.wrapperWU}>
            <div className={cardStyles.container}>
              <section className={cardStyles.section}>
                <h4>Overhead Mobility #6</h4>
                <p>Requires a ring. BUT, using a band or broom stick, work the shoulders from an overhead position, arms spread, to a behind the back position.</p>
              </section>
            </div>
            <ul className={cardStyles.bgBubbles}>
              <li></li>
        ...
        <div className={cardStyles.box}>
          <div className={cardStyles.wrapperWU}>
            <div className={cardStyles.container}>
              <section className={cardStyles.section}>
                <h4>Overhead Mobility #7</h4>
                <p>Requires a pull up bar. BUT, using a band in each hand and wrapped behind the upper back, bring the hands together in front of the body (shoulder blades opened up) then extended out to the sides (shoulder blades close together).</p>
              </section>
            </div>
            <ul className={cardStyles.bgBubbles}>
              <li></li>
      ...
      <div className={videoStyles.videoResponsive}>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/oLwTC-lAJws" title='Athlean-X' frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      </div>
