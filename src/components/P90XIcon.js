...
const SVG = ({
  ...
  viewBox = "0 0 200 128"
    ...
    >
      <g id="p90x" stroke="none" strokeWidth="1" fill={fill} fillRule="evenodd">
        <text id="P90X" fontFamily="Nunito-Black, Nunito Black" fontSize="34" fontWeight="700" fill={fill}>
          <tspan x="46.212" y="116">P90X</tspan>
        </text>
